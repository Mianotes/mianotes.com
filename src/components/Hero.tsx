    ...
    <div className="relative overflow-hidden bg-slate-50 pt-16 pb-24 lg:pt-24 lg:pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="relative inline-block text-sm text-slate-500 italic mb-16">
            These docs were generated by Codex using{' '}
            <span className="relative inline-block">
              Mianotes.
              <svg
                viewBox="0 0 70 48"
                fill="none"
                className="pointer-events-none absolute -top-12 left-[62%] hidden h-12 w-[70px] text-slate-400 md:block"
                aria-hidden="true">
                
                <path
                  d="M6 41C18 20 39 10 63 8"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round" />
                <path
